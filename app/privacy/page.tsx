...
export const metadata: Metadata = {
  title: "Privacy Policy — Cognora AI",
  description: "How Cognora AI collects, uses, protects, and shares information.",
};
    ...
    <main className="legal-page">
      ...
      <article className="legal-document">
        ...
        <p className="legal-lead">
          Cognora AI (“Cognora,” “we,” “us,” or “our”) is a private learning workspace that helps
          ...
          explains what information Cognora handles and the choices available to you.
        </p>
        ...
        <section>
          ...
          <p>
            If you connect Google Calendar, Cognora receives authorization tokens and the calendar
            event information needed to create or update Cognora study sessions. If you purchase a
            plan, Stripe processes payment-card details; Cognora receives transaction, customer,
        ...
        <section>
          ...
          <ul>
            <li>Provide, personalize, secure, and maintain Cognora.</li>
        ...
        <section>
          ...
          <p>
            Cognora sends only the information needed for a requested AI feature to configured model
        ...
        <section>
          ...
          <p>
            Cognora requests the Google Calendar events scope to create, update, and maintain study
            sessions that originate from your Cognora plan. We do not use Google user data for
          ...
          <p>
            Cognora’s use and transfer of information received from Google APIs adheres to the
          ...
          <p>
            You can revoke Cognora’s access at any time from your Google Account’s third-party
        ...
        <section>
          ...
          <p>
            We share information only as needed with service providers that operate Cognora, such as
        ...
        <section>
          ...
          <p>
            Cognora uses access controls, private-by-default records, encrypted transport, and
        ...
        <section>
          ...
          <p>
            Cognora is not directed to children under 13. If local law requires parental, guardian,
        ...
        <section>
          ...
          <p>
            We may update this policy as Cognora evolves. Material changes will be reflected by a new
            effective date and, when appropriate, an in-product notice. For privacy questions or
            requests, use Cognora’s private in-app feedback channel. If you cannot access an account,
            contact the developer identified on Cognora’s Google OAuth consent screen.
          </p>
        </section>
      </article>
